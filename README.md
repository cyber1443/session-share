...
6. The cards move themselves. `plan → splitting → proposed → building → verify → review` follows what the agents have actually done; nothing is draggable, because a column you maintain by hand drifts from the truth the moment anyone is busy.
